...
ADD_SPECIFIC_HUMIDITY_INFO = True
...
TEMPERATURE_MA_A = TEMPERATURE + SUFFIX_MA_A
TEMPERATURE_MA_B = TEMPERATURE + SUFFIX_MA_B
TEMPERATURE_MA_C = TEMPERATURE + SUFFIX_MA_C
SPECIFIC_HUMIDITY = 'SpecificHumidity'
SPECIFIC_HUMIDITY_MA_A = SPECIFIC_HUMIDITY + SUFFIX_MA_A
SPECIFIC_HUMIDITY_MA_B = SPECIFIC_HUMIDITY + SUFFIX_MA_B
SPECIFIC_HUMIDITY_MA_C = SPECIFIC_HUMIDITY + SUFFIX_MA_C
...
INPUT_SCALE = {
    ...
    # ENVIRONMENT INFO
    TEMPERATURE_MA_A: 400,
    TEMPERATURE_MA_B: 400,
    TEMPERATURE_MA_C: 400,
    SPECIFIC_HUMIDITY_MA_A: 0.03,
    SPECIFIC_HUMIDITY_MA_B: 0.03,
    SPECIFIC_HUMIDITY_MA_C: 0.03,
    # CONFIRMED CASES
    CONFIRMED_CASES: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e8,  # 100 million,
    CONFIRMED_CASES_MA_A: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e8,  # 100 million
    CONFIRMED_CASES_MA_B: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e8,  # 100 million
    CONFIRMED_CASES_MA_C: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e8,  # 100 million
    # NEW CASES
    PREDICTED_NEW_CASES: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e6,
    PREDICTED_NEW_CASES_MA_A: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e6,
    PREDICTED_NEW_CASES_MA_B: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e6,
    PREDICTED_NEW_CASES_MA_C: 1.0 if CALCULATE_AS_PERCENT_OF_POPULATION else 1e6,
    POPULATION: 1e10,
...
REFERENCE_TEMPERATURES = 'data/geo_temps.csv'
